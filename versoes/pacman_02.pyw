...
def CheckInputs():
    ...
    if thisGame.mode == 1:
        ...
        #####################INPUTS DO SERVER##############################
        elif pygame.key.get_pressed()[ pygame.K_d ] or (int(m.msg) == 1): #or recebeu comando do server
            #player rede
            print m.msg
        ...
        elif pygame.key.get_pressed()[ pygame.K_a ] or (int(m.msg) == 2):
            if not thisLevel.CheckIfHitWall((playerServer.x - playerServer.speed, playerServer.y), (playerServer.nearestRow, playerServer.nearestCol)):
                playerServer.velX = -playerServer.speed
                playerServer.velY = 0


        elif pygame.key.get_pressed()[ pygame.K_s ] or (int(m.msg) == 3):
        ...
        elif pygame.key.get_pressed()[ pygame.K_w ] or (int(m.msg)== 4):
            if not thisLevel.CheckIfHitWall((playerServer.x, playerServer.y - playerServer.speed), (playerServer.nearestRow, playerServer.nearestCol)):
                playerServer.velX = 0
                playerServer.velY = -playerServer.speed
...
#
#     if thisGame.mode == 1:
#         if pygame.key.get_pressed()[ pygame.K_d ] : #or recebeu comando do server
#             #player rede
#             if not thisLevel.CheckIfHitWall((playerServer.x + playerServer.speed, playerServer.y), (playerServer.nearestRow, playerServer.nearestCol)):
#                 playerServer.velX = playerServer.speed
#                 playerServer.velY = 0
